...
<body>
                            ...
                            <div class="col-12">
                                ...
                                <div class="border rounded-2 overflow-hidden">
                                    <label class="d-flex align-items-center gap-3 px-3 py-2 border-bottom" style="cursor:pointer; margin:0;">
                                        <input type="radio" name="sent_to" value="all" id="announcementSendToAll" style="accent-color:#2e7d32; flex-shrink:0;">
                                        <div>
                                            <div style="font-size:13px; font-weight:600; color:#1b5e20;">All Users</div>
                                        </div>
                                    </label>
                                    <label class="d-flex align-items-center gap-3 px-3 py-2 border-bottom" style="cursor:pointer; margin:0;">
                                        <input type="radio" name="sent_to" value="scholars" id="announcementSendToScholars" style="accent-color:#2e7d32; flex-shrink:0;">
                                        <div>
                                            <div style="font-size:13px; font-weight:600; color:#1b5e20;">Scholars Only</div>
                                        </div>
                                    </label>
                                    <label class="d-flex align-items-center gap-3 px-3 py-2 border-bottom" style="cursor:pointer; margin:0;">
                                        <input type="radio" name="sent_to" value="applicants" id="announcementSendToApplicants" style="accent-color:#2e7d32; flex-shrink:0;">
                                        <div>
                                    ...
                                    <label class="d-flex align-items-center gap-3 px-3 py-2" style="cursor:pointer; margin:0;">
                                        <input type="radio" name="sent_to" value="specific" id="announcementSendToSpecific" style="accent-color:#2e7d32; flex-shrink:0;">
                                        <div>
    ...
    <script>
        ...
        function openAddAnnouncement(committeeId) {
            ...
            document.getElementById('announcementSendToAll').checked = true;
        ...
        function openEditAnnouncement(a) {
            ...
            const radio = document.getElementById('announcementSendTo' + sentTo.charAt(0).toUpperCase() + sentTo.slice(1));
