...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_beneficiary'])) {
        ...
        if ($valid && $items !== '' && $quantity > 0) {
            ...
            $stmt->execute();
            $stmt->close();
            logAudit('Added In-Kind Beneficiary', 'Sports application #' . $applicationId);
    ...
    header("Location: SportsInkindAssistance.php" . ($programId !== null ? '?program_id=' . $programId : ''));
    exit();
}
...
$activeLink = 'SportsInkindAssistance';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title><?php echo e($activeProgram ? $activeProgram['name'] : 'Sports'); ?> In-Kind Assistance Beneficiaries</title>
...
<body>
    ...
    <div class="main-content">
        <h4 class="fw-bold mb-1"><?php echo e($activeProgram ? $activeProgram['name'] : 'Sports'); ?> In-Kind Assistance Beneficiaries</h4>
        <p class="text-muted mb-2" style="font-size: 13px;">
            <?php if ($activeProgram): ?>
                Viewing beneficiaries for the <?php echo e($activeProgram['name']); ?> program only. <a href="SportsInkindAssistance.php">View all Sports programs</a>.
            <?php else: ?>
                Monitor beneficiaries approved for Sports in-kind assistance.
            <?php endif; ?>
        </p>
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        <?php if (empty($displayRows)): ?>
                            <tr>
                                <td colspan="<?php echo !empty($committeePrograms) ? 8 : 7; ?>" class="text-center text-muted py-4">No <?php echo e($activeProgram ? $activeProgram['name'] : 'sports'); ?> in-kind assistance beneficiaries found.</td>
                            </tr>
                        <?php endif; ?>
                ...
                <form method="post">
                    ...
                    <div class="modal-body p-4">
                        <?php if (empty($eligibleApplications)): ?>
                            <div class="alert alert-warning py-2 mb-0">There are no approved Sports applicants awaiting in-kind assistance setup right now.</div>
                        <?php else: ?>
