...
// Every custom program added under Education's Assistance track (e.g. "test1") has its own
// independent form — so reflect which program tab the admin actually clicked (via ?ptab=) in the
// heading instead of always showing the base tab's label.
$baseTabLabel = getProgramTab($committeeId, 'assistance', 'Education Assistance Program')['label'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: EducationAssistanceForms.php" . ($viewingTab ? '?ptab=' . $viewingTab['tab_id'] : ''));
    exit();
}
...
$activeLink = 'EducationAssistanceForms';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Application Form - Education Assistance</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <p class="text-muted mb-2" style="font-size: 13px;">
            ...
            <?php if ($viewingTab): ?>
                This form is independent from <strong><?php echo e($baseTabLabel); ?></strong> and every other Education Assistance program — it started as a copy of the base form, and changes here only affect <strong><?php echo e($formHeading); ?></strong>.
            <?php endif; ?>
        </p>
                ...
                <form method="post">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-3" id="optionsFieldWrap" style="display:none;">
                            ...
                            <input type="text" class="form-control form-control-sm" name="options" id="fieldOptionsInput" placeholder="e.g. Tuition Fee Assistance, School Supplies Assistance">
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <div class="preview-form-card p-2">
                        <h5 class="text-center fw-bold mb-4" style="letter-spacing:0.5px;"><?php echo e(mb_strtoupper($formHeading)); ?> APPLICATION FORM</h5>
