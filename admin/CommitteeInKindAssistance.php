...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_beneficiary'])) {
        ...
        if ($valid && $items !== '' && $quantity > 0) {
            ...
            $stmt->execute();
            $stmt->close();
            logAudit('Added In-Kind Beneficiary', $committee['name'] . ' application #' . $applicationId);
    ...
    header("Location: CommitteeInKindAssistance.php?committee=" . $committeeId . ($programId !== null ? '&program_id=' . $programId : ''));
    exit();
}
...
$activeLink = 'CommitteeInKindAssistance_' . $committeeId;
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title><?php echo e($activeProgram ? $activeProgram['name'] : $committee['name']); ?> In-Kind Assistance Beneficiaries</title>
...
<body>
    ...
    <div class="main-content">
        <h4 class="fw-bold mb-1"><?php echo e($activeProgram ? $activeProgram['name'] : $committee['name']); ?> In-Kind Assistance Beneficiaries</h4>
        <p class="text-muted mb-2" style="font-size: 13px;">
            <?php if ($activeProgram): ?>
                Viewing beneficiaries for the <?php echo e($activeProgram['name']); ?> program only. <a href="CommitteeInKindAssistance.php?committee=<?php echo $committeeId; ?>">View all <?php echo e($committee['name']); ?> programs</a>.
            <?php else: ?>
                Monitor beneficiaries approved for <?php echo e($committee['name']); ?> in-kind assistance.
            <?php endif; ?>
        </p>
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        <?php if (empty($displayRows)): ?>
                            <tr>
                                <td colspan="<?php echo !empty($committeePrograms) ? 8 : 7; ?>" class="text-center text-muted py-4">No <?php echo e($activeProgram ? $activeProgram['name'] : $committee['name']); ?> in-kind assistance beneficiaries found.</td>
                            </tr>
                        <?php endif; ?>
                ...
                <form method="post">
                    ...
                    <div class="modal-body p-4">
                        <?php if (empty($eligibleApplications)): ?>
                            <div class="alert alert-warning py-2 mb-0">There are no approved <?php echo e($committee['name']); ?> applicants awaiting in-kind assistance setup right now.</div>
                        <?php else: ?>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="items" placeholder="e.g. Relief Goods Package" required>
                                </div>
                                <div class="col-md-3">
