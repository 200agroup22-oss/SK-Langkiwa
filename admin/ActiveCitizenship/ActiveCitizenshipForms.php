...
// Every custom program added under Active Citizenship's Assistance track has its own independent
// form — so reflect which program tab the admin actually clicked (via ?ptab=) in the heading
// instead of always showing the base tab's label.
$baseTabLabel = getProgramTab($committeeId, 'assistance', 'Active Citizenship Assistance Program')['label'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: ActiveCitizenshipForms.php" . ($viewingTab ? '?ptab=' . $viewingTab['tab_id'] : ''));
    exit();
}
...
$activeLink = 'ActiveCitizenshipForms';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Application Form - Active Citizenship</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <p class="text-muted mb-2" style="font-size: 13px;">
            ...
            <?php if ($viewingTab): ?>
                This form is independent from <strong><?php echo e($baseTabLabel); ?></strong> and every other Active Citizenship program — it started as a copy of the base form, and changes here only affect <strong><?php echo e($formHeading); ?></strong>.
            <?php endif; ?>
        </p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <div class="preview-form-card p-2">
                        <h5 class="text-center fw-bold mb-4" style="letter-spacing:0.5px;">ACTIVE CITIZENSHIP APPLICATION FORM</h5>
